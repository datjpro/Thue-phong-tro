...
export const Badge = ({ className, variant = 'default', ...props }: BadgeProps) => {
  return (
    <div
      className={twMerge(
        clsx(
          'inline-flex items-center rounded-full border px-2.5 py-0.5 text-[9px] font-black uppercase tracking-widest transition-all duration-200 select-none shadow-sm',
          {
            'border-transparent bg-gradient-primary text-white': variant === 'default',
